/* Generated by "click-buildtool elem2export" on Die Okt 11 16:40:54 CEST 2016 */
...
#include "../elements/local/nullagnostic.hh"
...
#include "../elements/local/editsource.hh"
...
#include "../elements/local/nullpush.hh"
...
#include "../elements/local/simplepushelement.hh"
...
#include "../elements/local/nullpull.hh"
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 109: return new Editsource;
   case 110: return new Nullagnostic;
   case 111: return new Nullpull;
   case 112: return new Nullpush;
   case 113: return new SimplePushElement;
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("EditSource", beetlemonkey, 109);
  (void) click_add_element_type_stable("Nullagnostic", beetlemonkey, 110);
  (void) click_add_element_type_stable("Nullpull", beetlemonkey, 111);
  (void) click_add_element_type_stable("Nullpush", beetlemonkey, 112);
  (void) click_add_element_type_stable("SimplePushElement", beetlemonkey, 113);
