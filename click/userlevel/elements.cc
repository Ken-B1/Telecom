/* Generated by "click-buildtool elem2export" on Sam Nov 26 20:20:24 CET 2016 */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 112: return new QueryGenerator;
   case 113: return new QueryResponder;
   case 114: return new IGMPRouterState;
   case 115: return new UserinfoBase;
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("QueryGenerator", beetlemonkey, 112);
  (void) click_add_element_type_stable("QueryResponder", beetlemonkey, 113);
  (void) click_add_element_type_stable("IGMPRouterState", beetlemonkey, 114);
  (void) click_add_element_type_stable("UserinfoBase", beetlemonkey, 115);
