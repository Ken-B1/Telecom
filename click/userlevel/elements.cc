/* Generated by "click-buildtool elem2export" on Fre Nov 25 17:32:12 CET 2016 */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 112: return new IGMPRouterState;
   case 113: return new SimpleIdle;
   case 114: return new SimplePrioSched;
   case 115: return new SimplePullSwitch;
   case 116: return new SimpleRRSched;
   case 117: return new AddressInfo;
   case 118: return new Align;
   case 119: return new AlignmentInfo;
   case 120: return new AnnotationInfo;
   case 121: return new AverageCounter;
   case 122: return new BandwidthMeter;
   case 123: return new BandwidthShaper;
   case 124: return new Block;
   case 125: return new Burster;
   case 126: return new BandwidthRatedSplitter;
   case 127: return new BandwidthRatedUnqueue;
   case 128: return new CheckCRC32;
   case 129: return new CheckLength;
   case 130: return new CheckPaint;
   case 131: return new Classifier;
   case 132: return new ClickyInfo;
   case 133: return new CompareBlock;
   case 134: return new Counter;
   ...
   case 152: return new LinkUnqueue;
   case 153: return new MarkMACHeader;
   case 154: return new MessageElement;
   case 155: return new Meter;
   case 156: return new MixedQueue;
   case 157: return new NotifierQueue;
   case 158: return new NullElement;
   case 159: return new PushNullElement;
   case 160: return new PullNullElement;
   case 161: return new Null1;
   case 162: return new Null2;
   case 163: return new Null3;
   ...
   case 169: return new Paint;
   case 170: return new PaintSwitch;
   case 171: return new PaintTee;
   case 172: return new PortInfo;
   case 173: return new Print;
   case 174: return new PrioSched;
   case 175: return new PullSwitch;
   case 176: return new QuickNoteQueue;
   case 177: return new QuitWatcher;
   case 178: return new RandomBitErrors;
   case 179: return new RandomSample;
   case 180: return new RandomSource;
   case 181: return new RandomSwitch;
   case 182: return new RatedSource;
   case 183: return new RatedSplitter;
   case 184: return new RatedUnqueue;
   case 185: return new RRSched;
   case 186: return new RoundRobinSwitch;
   case 187: return new ScheduleInfo;
   case 188: return new Script;
   case 189: return new SetAnnoByte;
   case 190: return new SetCRC32;
   case 191: return new SetPacketType;
   case 192: return new SetTimestamp;
   case 193: return new Shaper;
   case 194: return new SimpleQueue;
   case 195: return new StaticPullSwitch;
   case 196: return new StaticSwitch;
   case 197: return new StoreData;
   case 198: return new StrideSched;
   case 199: return new StrideSwitch;
   case 200: return new Strip;
   case 201: return new StripToNetworkHeader;
   case 202: return new Suppressor;
   case 203: return new Switch;
   case 204: return new Tee;
   case 205: return new PullTee;
   case 206: return new ThreadSafeQueue;
   case 207: return new TimedSink;
   case 208: return new TimedSource;
   case 209: return new TimedUnqueue;
   case 210: return new Truncate;
   case 211: return new Unqueue;
   case 212: return new Unqueue2;
   case 213: return new Unstrip;
   case 214: return new CheckTCPHeader;
   case 215: return new CheckUDPHeader;
   case 216: return new DynamicUDPIPEncap;
   case 217: return new IPRewriter;
   case 218: return new SetTCPChecksum;
   case 219: return new SetUDPChecksum;
   case 220: return new TCPFragmenter;
   case 221: return new TCPIPSend;
   case 222: return new TCPRewriter;
   case 223: return new UDPIPEncap;
   case 224: return new UDPRewriter;
   case 225: return new BigHashMapTest;
   case 226: return new BigintTest;
   case 227: return new BlockThread;
   case 228: return new CheckPacket;
   case 229: return new CLPTest;
   case 230: return new ComparePackets;
   case 231: return new ConfParseTest;
   case 232: return new CryptoTest;
   case 233: return new ErrorTest;
   case 234: return new FunctionTest;
   case 235: return new HandlerTask;
   case 236: return new HashTableTest;
   case 237: return new HeapTest;
   case 238: return new ListTest;
   case 239: return new NeighborhoodTest;
   case 240: return new NotifierDebug;
   case 241: return new NullTask;
   case 242: return new PacketTest;
   case 243: return new QueueYankTest;
   case 244: return new RandomSeed;
   case 245: return new SchedOrderTest;
   case 246: return new SortTest;
   case 247: return new TimerTest;
   case 248: return new TokenBucketTest;
   case 249: return new UpstreamNotifier;
   case 250: return new VectorTest;
   case 251: return new SpinlockAcquire;
   case 252: return new SpinlockInfo;
   case 253: return new SpinlockRelease;
   case 254: return new StaticThreadSched;
   case 255: return new ChangeUID;
   case 256: return new ChatterSocket;
   case 257: return new ControlSocket;
   case 258: return new FromDevice;
   case 259: return new FromDump;
   case 260: return new FromHost;
   case 261: return new FromRawSocket;
   case 262: return new FromSocket;
   case 263: return new KernelFilter;
   case 264: return new KernelTap;
   case 265: return new KernelTun;
   case 266: return new KernelHandlerProxy;
   case 267: return new ProgressBar;
   case 268: return new RawSocket;
   case 269: return new Socket;
   case 270: return new ToDevice;
   case 271: return new ToDump;
   case 272: return new ToHost;
   case 273: return new ToRawSocket;
   case 274: return new ToSocket;
   case 275: return new UMLSwitch;
   default: return 0;
  }
}
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("IGMPRouterState", beetlemonkey, 112);
  (void) click_add_element_type_stable("SimpleIdle", beetlemonkey, 113);
  (void) click_add_element_type_stable("SimplePrioSched", beetlemonkey, 114);
  (void) click_add_element_type_stable("SimplePullSwitch", beetlemonkey, 115);
  (void) click_add_element_type_stable("SimpleRoundRobinSched", beetlemonkey, 116);
  (void) click_add_element_type_stable("AddressInfo", beetlemonkey, 117);
  (void) click_add_element_type_stable("Align", beetlemonkey, 118);
  (void) click_add_element_type_stable("AlignmentInfo", beetlemonkey, 119);
  (void) click_add_element_type_stable("AnnotationInfo", beetlemonkey, 120);
  (void) click_add_element_type_stable("AverageCounter", beetlemonkey, 121);
  (void) click_add_element_type_stable("BandwidthMeter", beetlemonkey, 122);
  (void) click_add_element_type_stable("BandwidthShaper", beetlemonkey, 123);
  (void) click_add_element_type_stable("Block", beetlemonkey, 124);
  (void) click_add_element_type_stable("Burster", beetlemonkey, 125);
  (void) click_add_element_type_stable("BandwidthRatedSplitter", beetlemonkey, 126);
  (void) click_add_element_type_stable("BandwidthRatedUnqueue", beetlemonkey, 127);
  (void) click_add_element_type_stable("CheckCRC32", beetlemonkey, 128);
  (void) click_add_element_type_stable("CheckLength", beetlemonkey, 129);
  (void) click_add_element_type_stable("CheckPaint", beetlemonkey, 130);
  (void) click_add_element_type_stable("Classifier", beetlemonkey, 131);
  (void) click_add_element_type_stable("ClickyInfo", beetlemonkey, 132);
  (void) click_add_element_type_stable("CompareBlock", beetlemonkey, 133);
  (void) click_add_element_type_stable("Counter", beetlemonkey, 134);
  ...
  (void) click_add_element_type_stable("LinkUnqueue", beetlemonkey, 152);
  (void) click_add_element_type_stable("MarkMACHeader", beetlemonkey, 153);
  (void) click_add_element_type_stable("Message", beetlemonkey, 154);
  (void) click_add_element_type_stable("Meter", beetlemonkey, 155);
  (void) click_add_element_type_stable("MixedQueue", beetlemonkey, 156);
  (void) click_add_element_type_stable("NotifierQueue", beetlemonkey, 157);
  (void) click_add_element_type_stable("Null", beetlemonkey, 158);
  (void) click_add_element_type_stable("PushNull", beetlemonkey, 159);
  (void) click_add_element_type_stable("PullNull", beetlemonkey, 160);
  (void) click_add_element_type_stable("Null1", beetlemonkey, 161);
  (void) click_add_element_type_stable("Null2", beetlemonkey, 162);
  (void) click_add_element_type_stable("Null3", beetlemonkey, 163);
  ...
  (void) click_add_element_type_stable("Paint", beetlemonkey, 169);
  (void) click_add_element_type_stable("PaintSwitch", beetlemonkey, 170);
  (void) click_add_element_type_stable("PaintTee", beetlemonkey, 171);
  (void) click_add_element_type_stable("PortInfo", beetlemonkey, 172);
  (void) click_add_element_type_stable("Print", beetlemonkey, 173);
  (void) click_add_element_type_stable("PrioSched", beetlemonkey, 174);
  (void) click_add_element_type_stable("PullSwitch", beetlemonkey, 175);
  (void) click_add_element_type_stable("QuickNoteQueue", beetlemonkey, 176);
  (void) click_add_element_type_stable("QuitWatcher", beetlemonkey, 177);
  (void) click_add_element_type_stable("RandomBitErrors", beetlemonkey, 178);
  (void) click_add_element_type_stable("RandomSample", beetlemonkey, 179);
  (void) click_add_element_type_stable("RandomSource", beetlemonkey, 180);
  (void) click_add_element_type_stable("RandomSwitch", beetlemonkey, 181);
  (void) click_add_element_type_stable("RatedSource", beetlemonkey, 182);
  (void) click_add_element_type_stable("RatedSplitter", beetlemonkey, 183);
  (void) click_add_element_type_stable("RatedUnqueue", beetlemonkey, 184);
  (void) click_add_element_type_stable("RoundRobinSched", beetlemonkey, 185);
  (void) click_add_element_type_stable("RoundRobinSwitch", beetlemonkey, 186);
  (void) click_add_element_type_stable("ScheduleInfo", beetlemonkey, 187);
  (void) click_add_element_type_stable("Script", beetlemonkey, 188);
  Script::static_initialize();
  (void) click_add_element_type_stable("SetAnnoByte", beetlemonkey, 189);
  (void) click_add_element_type_stable("SetCRC32", beetlemonkey, 190);
  (void) click_add_element_type_stable("SetPacketType", beetlemonkey, 191);
  (void) click_add_element_type_stable("SetTimestamp", beetlemonkey, 192);
  (void) click_add_element_type_stable("Shaper", beetlemonkey, 193);
  (void) click_add_element_type_stable("SimpleQueue", beetlemonkey, 194);
  (void) click_add_element_type_stable("StaticPullSwitch", beetlemonkey, 195);
  (void) click_add_element_type_stable("StaticSwitch", beetlemonkey, 196);
  (void) click_add_element_type_stable("StoreData", beetlemonkey, 197);
  (void) click_add_element_type_stable("StrideSched", beetlemonkey, 198);
  (void) click_add_element_type_stable("StrideSwitch", beetlemonkey, 199);
  (void) click_add_element_type_stable("Strip", beetlemonkey, 200);
  (void) click_add_element_type_stable("StripToNetworkHeader", beetlemonkey, 201);
  (void) click_add_element_type_stable("Suppressor", beetlemonkey, 202);
  (void) click_add_element_type_stable("Switch", beetlemonkey, 203);
  (void) click_add_element_type_stable("Tee", beetlemonkey, 204);
  (void) click_add_element_type_stable("PullTee", beetlemonkey, 205);
  (void) click_add_element_type_stable("ThreadSafeQueue", beetlemonkey, 206);
  (void) click_add_element_type_stable("TimedSink", beetlemonkey, 207);
  (void) click_add_element_type_stable("TimedSource", beetlemonkey, 208);
  (void) click_add_element_type_stable("TimedUnqueue", beetlemonkey, 209);
  (void) click_add_element_type_stable("Truncate", beetlemonkey, 210);
  (void) click_add_element_type_stable("Unqueue", beetlemonkey, 211);
  (void) click_add_element_type_stable("Unqueue2", beetlemonkey, 212);
  (void) click_add_element_type_stable("Unstrip", beetlemonkey, 213);
  (void) click_add_element_type_stable("CheckTCPHeader", beetlemonkey, 214);
  (void) click_add_element_type_stable("CheckUDPHeader", beetlemonkey, 215);
  (void) click_add_element_type_stable("DynamicUDPIPEncap", beetlemonkey, 216);
  (void) click_add_element_type_stable("IPRewriter", beetlemonkey, 217);
  (void) click_add_element_type_stable("SetTCPChecksum", beetlemonkey, 218);
  (void) click_add_element_type_stable("SetUDPChecksum", beetlemonkey, 219);
  (void) click_add_element_type_stable("TCPFragmenter", beetlemonkey, 220);
  (void) click_add_element_type_stable("TCPIPSend", beetlemonkey, 221);
  (void) click_add_element_type_stable("TCPRewriter", beetlemonkey, 222);
  (void) click_add_element_type_stable("UDPIPEncap", beetlemonkey, 223);
  (void) click_add_element_type_stable("UDPRewriter", beetlemonkey, 224);
  (void) click_add_element_type_stable("BigHashMapTest", beetlemonkey, 225);
  (void) click_add_element_type_stable("BigintTest", beetlemonkey, 226);
  (void) click_add_element_type_stable("BlockThread", beetlemonkey, 227);
  (void) click_add_element_type_stable("CheckPacket", beetlemonkey, 228);
  (void) click_add_element_type_stable("CLPTest", beetlemonkey, 229);
  (void) click_add_element_type_stable("ComparePackets", beetlemonkey, 230);
  (void) click_add_element_type_stable("ConfParseTest", beetlemonkey, 231);
  (void) click_add_element_type_stable("CryptoTest", beetlemonkey, 232);
  (void) click_add_element_type_stable("ErrorTest", beetlemonkey, 233);
  (void) click_add_element_type_stable("FunctionTest", beetlemonkey, 234);
  (void) click_add_element_type_stable("HandlerTask", beetlemonkey, 235);
  (void) click_add_element_type_stable("HashTableTest", beetlemonkey, 236);
  (void) click_add_element_type_stable("HeapTest", beetlemonkey, 237);
  (void) click_add_element_type_stable("ListTest", beetlemonkey, 238);
  (void) click_add_element_type_stable("NeighborhoodTest", beetlemonkey, 239);
  (void) click_add_element_type_stable("NotifierDebug", beetlemonkey, 240);
  (void) click_add_element_type_stable("NullTask", beetlemonkey, 241);
  (void) click_add_element_type_stable("PacketTest", beetlemonkey, 242);
  (void) click_add_element_type_stable("QueueYankTest", beetlemonkey, 243);
  (void) click_add_element_type_stable("RandomSeed", beetlemonkey, 244);
  (void) click_add_element_type_stable("SchedOrderTest", beetlemonkey, 245);
  (void) click_add_element_type_stable("SortTest", beetlemonkey, 246);
  (void) click_add_element_type_stable("TimerTest", beetlemonkey, 247);
  (void) click_add_element_type_stable("TokenBucketTest", beetlemonkey, 248);
  (void) click_add_element_type_stable("UpstreamNotifier", beetlemonkey, 249);
  (void) click_add_element_type_stable("VectorTest", beetlemonkey, 250);
  (void) click_add_element_type_stable("SpinlockAcquire", beetlemonkey, 251);
  (void) click_add_element_type_stable("SpinlockInfo", beetlemonkey, 252);
  (void) click_add_element_type_stable("SpinlockRelease", beetlemonkey, 253);
  (void) click_add_element_type_stable("StaticThreadSched", beetlemonkey, 254);
  (void) click_add_element_type_stable("ChangeUID", beetlemonkey, 255);
  (void) click_add_element_type_stable("ChatterSocket", beetlemonkey, 256);
  (void) click_add_element_type_stable("ControlSocket", beetlemonkey, 257);
  (void) click_add_element_type_stable("FromDevice", beetlemonkey, 258);
  (void) click_add_element_type_stable("FromDump", beetlemonkey, 259);
  (void) click_add_element_type_stable("FromHost", beetlemonkey, 260);
  (void) click_add_element_type_stable("FromRawSocket", beetlemonkey, 261);
  (void) click_add_element_type_stable("FromSocket", beetlemonkey, 262);
  (void) click_add_element_type_stable("KernelFilter", beetlemonkey, 263);
  (void) click_add_element_type_stable("KernelTap", beetlemonkey, 264);
  (void) click_add_element_type_stable("KernelTun", beetlemonkey, 265);
  (void) click_add_element_type_stable("KernelHandlerProxy", beetlemonkey, 266);
  (void) click_add_element_type_stable("ProgressBar", beetlemonkey, 267);
  (void) click_add_element_type_stable("RawSocket", beetlemonkey, 268);
  (void) click_add_element_type_stable("Socket", beetlemonkey, 269);
  (void) click_add_element_type_stable("ToDevice", beetlemonkey, 270);
  (void) click_add_element_type_stable("ToDump", beetlemonkey, 271);
  (void) click_add_element_type_stable("ToHost", beetlemonkey, 272);
  (void) click_add_element_type_stable("ToRawSocket", beetlemonkey, 273);
  (void) click_add_element_type_stable("ToSocket", beetlemonkey, 274);
  (void) click_add_element_type_stable("UMLSwitch", beetlemonkey, 275);
