/* Generated by "click-buildtool elem2export" on Fre Nov 25 14:48:07 CET 2016 */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 109: return new IGMPStateupdate;
   case 110: return new IGMPRouterState;
   case 111: return new multicastuser;
   case 112: return new SimpleIdle;
   case 113: return new SimplePrioSched;
   case 114: return new SimplePullSwitch;
   case 115: return new SimpleRRSched;
   ...
   case 131: return new ClickyInfo;
   case 132: return new CompareBlock;
   case 133: return new Counter;
   case 134: return new DelayShaper;
   case 135: return new DelayUnqueue;
   case 136: return new DevirtualizeInfo;
   case 137: return new Discard;
   case 138: return new DiscardNoFree;
   case 139: return new DriverManager;
   case 140: return new DropBroadcasts;
   case 141: return new DRRSched;
   case 142: return new ErrorElement;
   case 143: return new FlowInfo;
   case 144: return new FrontDropQueue;
   case 145: return new FullNoteQueue;
   case 146: return new FullNoteQueue;
   case 147: return new HashSwitch;
   case 148: return new Hub;
   case 149: return new Idle;
   case 150: return new InfiniteSource;
   case 151: return new LinkUnqueue;
   case 152: return new MarkMACHeader;
   case 153: return new MessageElement;
   case 154: return new Meter;
   case 155: return new MixedQueue;
   case 156: return new NotifierQueue;
   case 157: return new NullElement;
   case 158: return new PushNullElement;
   case 159: return new PullNullElement;
   case 160: return new Null1;
   case 161: return new Null2;
   case 162: return new Null3;
   case 163: return new Null4;
   case 164: return new Null5;
   case 165: return new Null6;
   case 166: return new Null7;
   case 167: return new Null8;
   case 168: return new Paint;
   case 169: return new PaintSwitch;
   case 170: return new PaintTee;
   case 171: return new PortInfo;
   case 172: return new Print;
   case 173: return new PrioSched;
   case 174: return new PullSwitch;
   case 175: return new QuickNoteQueue;
   case 176: return new QuitWatcher;
   case 177: return new RandomBitErrors;
   case 178: return new RandomSample;
   case 179: return new RandomSource;
   case 180: return new RandomSwitch;
   case 181: return new RatedSource;
   case 182: return new RatedSplitter;
   case 183: return new RatedUnqueue;
   case 184: return new RRSched;
   case 185: return new RoundRobinSwitch;
   case 186: return new ScheduleInfo;
   case 187: return new Script;
   case 188: return new SetAnnoByte;
   case 189: return new SetCRC32;
   case 190: return new SetPacketType;
   case 191: return new SetTimestamp;
   case 192: return new Shaper;
   case 193: return new SimpleQueue;
   case 194: return new StaticPullSwitch;
   case 195: return new StaticSwitch;
   case 196: return new StoreData;
   case 197: return new StrideSched;
   case 198: return new StrideSwitch;
   case 199: return new Strip;
   case 200: return new StripToNetworkHeader;
   case 201: return new Suppressor;
   case 202: return new Switch;
   case 203: return new Tee;
   case 204: return new PullTee;
   case 205: return new ThreadSafeQueue;
   case 206: return new TimedSink;
   case 207: return new TimedSource;
   case 208: return new TimedUnqueue;
   case 209: return new Truncate;
   case 210: return new Unqueue;
   case 211: return new Unqueue2;
   case 212: return new Unstrip;
   case 213: return new CheckTCPHeader;
   case 214: return new CheckUDPHeader;
   case 215: return new DynamicUDPIPEncap;
   case 216: return new IPRewriter;
   case 217: return new SetTCPChecksum;
   case 218: return new SetUDPChecksum;
   case 219: return new TCPFragmenter;
   case 220: return new TCPIPSend;
   case 221: return new TCPRewriter;
   case 222: return new UDPIPEncap;
   case 223: return new UDPRewriter;
   case 224: return new BigHashMapTest;
   case 225: return new BigintTest;
   case 226: return new BlockThread;
   case 227: return new CheckPacket;
   case 228: return new CLPTest;
   case 229: return new ComparePackets;
   case 230: return new ConfParseTest;
   case 231: return new CryptoTest;
   case 232: return new ErrorTest;
   case 233: return new FunctionTest;
   case 234: return new HandlerTask;
   case 235: return new HashTableTest;
   case 236: return new HeapTest;
   case 237: return new ListTest;
   case 238: return new NeighborhoodTest;
   case 239: return new NotifierDebug;
   case 240: return new NullTask;
   case 241: return new PacketTest;
   case 242: return new QueueYankTest;
   case 243: return new RandomSeed;
   case 244: return new SchedOrderTest;
   case 245: return new SortTest;
   case 246: return new TimerTest;
   case 247: return new TokenBucketTest;
   case 248: return new UpstreamNotifier;
   case 249: return new VectorTest;
   case 250: return new SpinlockAcquire;
   case 251: return new SpinlockInfo;
   case 252: return new SpinlockRelease;
   case 253: return new StaticThreadSched;
   case 254: return new ChangeUID;
   case 255: return new ChatterSocket;
   case 256: return new ControlSocket;
   case 257: return new FromDevice;
   case 258: return new FromDump;
   case 259: return new FromHost;
   case 260: return new FromRawSocket;
   case 261: return new FromSocket;
   case 262: return new KernelFilter;
   case 263: return new KernelTap;
   case 264: return new KernelTun;
   case 265: return new KernelHandlerProxy;
   case 266: return new ProgressBar;
   case 267: return new RawSocket;
   case 268: return new Socket;
   case 269: return new ToDevice;
   case 270: return new ToDump;
   case 271: return new ToHost;
   case 272: return new ToRawSocket;
   case 273: return new ToSocket;
   case 274: return new UMLSwitch;
   default: return 0;
  }
}
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("IGMPStateupdate", beetlemonkey, 109);
  (void) click_add_element_type_stable("IGMPRouterState", beetlemonkey, 110);
  (void) click_add_element_type_stable("multicastuser", beetlemonkey, 111);
  (void) click_add_element_type_stable("SimpleIdle", beetlemonkey, 112);
  (void) click_add_element_type_stable("SimplePrioSched", beetlemonkey, 113);
  (void) click_add_element_type_stable("SimplePullSwitch", beetlemonkey, 114);
  (void) click_add_element_type_stable("SimpleRoundRobinSched", beetlemonkey, 115);
  (void) click_add_element_type_stable("AddressInfo", beetlemonkey, 116);
  (void) click_add_element_type_stable("Align", beetlemonkey, 117);
  (void) click_add_element_type_stable("AlignmentInfo", beetlemonkey, 118);
  (void) click_add_element_type_stable("AnnotationInfo", beetlemonkey, 119);
  (void) click_add_element_type_stable("AverageCounter", beetlemonkey, 120);
  (void) click_add_element_type_stable("BandwidthMeter", beetlemonkey, 121);
  (void) click_add_element_type_stable("BandwidthShaper", beetlemonkey, 122);
  (void) click_add_element_type_stable("Block", beetlemonkey, 123);
  (void) click_add_element_type_stable("Burster", beetlemonkey, 124);
  (void) click_add_element_type_stable("BandwidthRatedSplitter", beetlemonkey, 125);
  (void) click_add_element_type_stable("BandwidthRatedUnqueue", beetlemonkey, 126);
  (void) click_add_element_type_stable("CheckCRC32", beetlemonkey, 127);
  (void) click_add_element_type_stable("CheckLength", beetlemonkey, 128);
  (void) click_add_element_type_stable("CheckPaint", beetlemonkey, 129);
  (void) click_add_element_type_stable("Classifier", beetlemonkey, 130);
  (void) click_add_element_type_stable("ClickyInfo", beetlemonkey, 131);
  (void) click_add_element_type_stable("CompareBlock", beetlemonkey, 132);
  (void) click_add_element_type_stable("Counter", beetlemonkey, 133);
  (void) click_add_element_type_stable("DelayShaper", beetlemonkey, 134);
  (void) click_add_element_type_stable("DelayUnqueue", beetlemonkey, 135);
  (void) click_add_element_type_stable("DevirtualizeInfo", beetlemonkey, 136);
  (void) click_add_element_type_stable("Discard", beetlemonkey, 137);
  (void) click_add_element_type_stable("DiscardNoFree", beetlemonkey, 138);
  (void) click_add_element_type_stable("DriverManager", beetlemonkey, 139);
  (void) click_add_element_type_stable("DropBroadcasts", beetlemonkey, 140);
  (void) click_add_element_type_stable("DRRSched", beetlemonkey, 141);
  (void) click_add_element_type_stable("ErrorElement", beetlemonkey, 142);
  (void) click_add_element_type_stable("FlowInfo", beetlemonkey, 143);
  (void) click_add_element_type_stable("FrontDropQueue", beetlemonkey, 144);
  (void) click_add_element_type_stable("Queue", beetlemonkey, 145);
  (void) click_add_element_type_stable("FullNoteQueue", beetlemonkey, 146);
  (void) click_add_element_type_stable("HashSwitch", beetlemonkey, 147);
  (void) click_add_element_type_stable("Hub", beetlemonkey, 148);
  (void) click_add_element_type_stable("Idle", beetlemonkey, 149);
  (void) click_add_element_type_stable("InfiniteSource", beetlemonkey, 150);
  (void) click_add_element_type_stable("LinkUnqueue", beetlemonkey, 151);
  (void) click_add_element_type_stable("MarkMACHeader", beetlemonkey, 152);
  (void) click_add_element_type_stable("Message", beetlemonkey, 153);
  (void) click_add_element_type_stable("Meter", beetlemonkey, 154);
  (void) click_add_element_type_stable("MixedQueue", beetlemonkey, 155);
  (void) click_add_element_type_stable("NotifierQueue", beetlemonkey, 156);
  (void) click_add_element_type_stable("Null", beetlemonkey, 157);
  (void) click_add_element_type_stable("PushNull", beetlemonkey, 158);
  (void) click_add_element_type_stable("PullNull", beetlemonkey, 159);
  (void) click_add_element_type_stable("Null1", beetlemonkey, 160);
  (void) click_add_element_type_stable("Null2", beetlemonkey, 161);
  (void) click_add_element_type_stable("Null3", beetlemonkey, 162);
  (void) click_add_element_type_stable("Null4", beetlemonkey, 163);
  (void) click_add_element_type_stable("Null5", beetlemonkey, 164);
  (void) click_add_element_type_stable("Null6", beetlemonkey, 165);
  (void) click_add_element_type_stable("Null7", beetlemonkey, 166);
  (void) click_add_element_type_stable("Null8", beetlemonkey, 167);
  (void) click_add_element_type_stable("Paint", beetlemonkey, 168);
  (void) click_add_element_type_stable("PaintSwitch", beetlemonkey, 169);
  (void) click_add_element_type_stable("PaintTee", beetlemonkey, 170);
  (void) click_add_element_type_stable("PortInfo", beetlemonkey, 171);
  (void) click_add_element_type_stable("Print", beetlemonkey, 172);
  (void) click_add_element_type_stable("PrioSched", beetlemonkey, 173);
  (void) click_add_element_type_stable("PullSwitch", beetlemonkey, 174);
  (void) click_add_element_type_stable("QuickNoteQueue", beetlemonkey, 175);
  (void) click_add_element_type_stable("QuitWatcher", beetlemonkey, 176);
  (void) click_add_element_type_stable("RandomBitErrors", beetlemonkey, 177);
  (void) click_add_element_type_stable("RandomSample", beetlemonkey, 178);
  (void) click_add_element_type_stable("RandomSource", beetlemonkey, 179);
  (void) click_add_element_type_stable("RandomSwitch", beetlemonkey, 180);
  (void) click_add_element_type_stable("RatedSource", beetlemonkey, 181);
  (void) click_add_element_type_stable("RatedSplitter", beetlemonkey, 182);
  (void) click_add_element_type_stable("RatedUnqueue", beetlemonkey, 183);
  (void) click_add_element_type_stable("RoundRobinSched", beetlemonkey, 184);
  (void) click_add_element_type_stable("RoundRobinSwitch", beetlemonkey, 185);
  (void) click_add_element_type_stable("ScheduleInfo", beetlemonkey, 186);
  (void) click_add_element_type_stable("Script", beetlemonkey, 187);
  Script::static_initialize();
  (void) click_add_element_type_stable("SetAnnoByte", beetlemonkey, 188);
  (void) click_add_element_type_stable("SetCRC32", beetlemonkey, 189);
  (void) click_add_element_type_stable("SetPacketType", beetlemonkey, 190);
  (void) click_add_element_type_stable("SetTimestamp", beetlemonkey, 191);
  (void) click_add_element_type_stable("Shaper", beetlemonkey, 192);
  (void) click_add_element_type_stable("SimpleQueue", beetlemonkey, 193);
  (void) click_add_element_type_stable("StaticPullSwitch", beetlemonkey, 194);
  (void) click_add_element_type_stable("StaticSwitch", beetlemonkey, 195);
  (void) click_add_element_type_stable("StoreData", beetlemonkey, 196);
  (void) click_add_element_type_stable("StrideSched", beetlemonkey, 197);
  (void) click_add_element_type_stable("StrideSwitch", beetlemonkey, 198);
  (void) click_add_element_type_stable("Strip", beetlemonkey, 199);
  (void) click_add_element_type_stable("StripToNetworkHeader", beetlemonkey, 200);
  (void) click_add_element_type_stable("Suppressor", beetlemonkey, 201);
  (void) click_add_element_type_stable("Switch", beetlemonkey, 202);
  (void) click_add_element_type_stable("Tee", beetlemonkey, 203);
  (void) click_add_element_type_stable("PullTee", beetlemonkey, 204);
  (void) click_add_element_type_stable("ThreadSafeQueue", beetlemonkey, 205);
  (void) click_add_element_type_stable("TimedSink", beetlemonkey, 206);
  (void) click_add_element_type_stable("TimedSource", beetlemonkey, 207);
  (void) click_add_element_type_stable("TimedUnqueue", beetlemonkey, 208);
  (void) click_add_element_type_stable("Truncate", beetlemonkey, 209);
  (void) click_add_element_type_stable("Unqueue", beetlemonkey, 210);
  (void) click_add_element_type_stable("Unqueue2", beetlemonkey, 211);
  (void) click_add_element_type_stable("Unstrip", beetlemonkey, 212);
  (void) click_add_element_type_stable("CheckTCPHeader", beetlemonkey, 213);
  (void) click_add_element_type_stable("CheckUDPHeader", beetlemonkey, 214);
  (void) click_add_element_type_stable("DynamicUDPIPEncap", beetlemonkey, 215);
  (void) click_add_element_type_stable("IPRewriter", beetlemonkey, 216);
  (void) click_add_element_type_stable("SetTCPChecksum", beetlemonkey, 217);
  (void) click_add_element_type_stable("SetUDPChecksum", beetlemonkey, 218);
  (void) click_add_element_type_stable("TCPFragmenter", beetlemonkey, 219);
  (void) click_add_element_type_stable("TCPIPSend", beetlemonkey, 220);
  (void) click_add_element_type_stable("TCPRewriter", beetlemonkey, 221);
  (void) click_add_element_type_stable("UDPIPEncap", beetlemonkey, 222);
  (void) click_add_element_type_stable("UDPRewriter", beetlemonkey, 223);
  (void) click_add_element_type_stable("BigHashMapTest", beetlemonkey, 224);
  (void) click_add_element_type_stable("BigintTest", beetlemonkey, 225);
  (void) click_add_element_type_stable("BlockThread", beetlemonkey, 226);
  (void) click_add_element_type_stable("CheckPacket", beetlemonkey, 227);
  (void) click_add_element_type_stable("CLPTest", beetlemonkey, 228);
  (void) click_add_element_type_stable("ComparePackets", beetlemonkey, 229);
  (void) click_add_element_type_stable("ConfParseTest", beetlemonkey, 230);
  (void) click_add_element_type_stable("CryptoTest", beetlemonkey, 231);
  (void) click_add_element_type_stable("ErrorTest", beetlemonkey, 232);
  (void) click_add_element_type_stable("FunctionTest", beetlemonkey, 233);
  (void) click_add_element_type_stable("HandlerTask", beetlemonkey, 234);
  (void) click_add_element_type_stable("HashTableTest", beetlemonkey, 235);
  (void) click_add_element_type_stable("HeapTest", beetlemonkey, 236);
  (void) click_add_element_type_stable("ListTest", beetlemonkey, 237);
  (void) click_add_element_type_stable("NeighborhoodTest", beetlemonkey, 238);
  (void) click_add_element_type_stable("NotifierDebug", beetlemonkey, 239);
  (void) click_add_element_type_stable("NullTask", beetlemonkey, 240);
  (void) click_add_element_type_stable("PacketTest", beetlemonkey, 241);
  (void) click_add_element_type_stable("QueueYankTest", beetlemonkey, 242);
  (void) click_add_element_type_stable("RandomSeed", beetlemonkey, 243);
  (void) click_add_element_type_stable("SchedOrderTest", beetlemonkey, 244);
  (void) click_add_element_type_stable("SortTest", beetlemonkey, 245);
  (void) click_add_element_type_stable("TimerTest", beetlemonkey, 246);
  (void) click_add_element_type_stable("TokenBucketTest", beetlemonkey, 247);
  (void) click_add_element_type_stable("UpstreamNotifier", beetlemonkey, 248);
  (void) click_add_element_type_stable("VectorTest", beetlemonkey, 249);
  (void) click_add_element_type_stable("SpinlockAcquire", beetlemonkey, 250);
  (void) click_add_element_type_stable("SpinlockInfo", beetlemonkey, 251);
  (void) click_add_element_type_stable("SpinlockRelease", beetlemonkey, 252);
  (void) click_add_element_type_stable("StaticThreadSched", beetlemonkey, 253);
  (void) click_add_element_type_stable("ChangeUID", beetlemonkey, 254);
  (void) click_add_element_type_stable("ChatterSocket", beetlemonkey, 255);
  (void) click_add_element_type_stable("ControlSocket", beetlemonkey, 256);
  (void) click_add_element_type_stable("FromDevice", beetlemonkey, 257);
  (void) click_add_element_type_stable("FromDump", beetlemonkey, 258);
  (void) click_add_element_type_stable("FromHost", beetlemonkey, 259);
  (void) click_add_element_type_stable("FromRawSocket", beetlemonkey, 260);
  (void) click_add_element_type_stable("FromSocket", beetlemonkey, 261);
  (void) click_add_element_type_stable("KernelFilter", beetlemonkey, 262);
  (void) click_add_element_type_stable("KernelTap", beetlemonkey, 263);
  (void) click_add_element_type_stable("KernelTun", beetlemonkey, 264);
  (void) click_add_element_type_stable("KernelHandlerProxy", beetlemonkey, 265);
  (void) click_add_element_type_stable("ProgressBar", beetlemonkey, 266);
  (void) click_add_element_type_stable("RawSocket", beetlemonkey, 267);
  (void) click_add_element_type_stable("Socket", beetlemonkey, 268);
  (void) click_add_element_type_stable("ToDevice", beetlemonkey, 269);
  (void) click_add_element_type_stable("ToDump", beetlemonkey, 270);
  (void) click_add_element_type_stable("ToHost", beetlemonkey, 271);
  (void) click_add_element_type_stable("ToRawSocket", beetlemonkey, 272);
  (void) click_add_element_type_stable("ToSocket", beetlemonkey, 273);
  (void) click_add_element_type_stable("UMLSwitch", beetlemonkey, 274);
