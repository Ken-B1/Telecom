/* Generated by "click-buildtool elem2export" on Mit Nov 23 20:10:13 CET 2016 */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 109: return new multicastuser;
   case 110: return new SimpleIdle;
   case 111: return new SimplePrioSched;
   case 112: return new SimplePullSwitch;
   case 113: return new SimpleRRSched;
   case 114: return new AddressInfo;
   case 115: return new Align;
   case 116: return new AlignmentInfo;
   case 117: return new AnnotationInfo;
   case 118: return new AverageCounter;
   case 119: return new BandwidthMeter;
   case 120: return new BandwidthShaper;
   case 121: return new Block;
   case 122: return new Burster;
   case 123: return new BandwidthRatedSplitter;
   case 124: return new BandwidthRatedUnqueue;
   ...
   case 130: return new CompareBlock;
   case 131: return new Counter;
   case 132: return new DelayShaper;
   case 133: return new DelayUnqueue;
   case 134: return new DevirtualizeInfo;
   case 135: return new Discard;
   case 136: return new DiscardNoFree;
   case 137: return new DriverManager;
   case 138: return new DropBroadcasts;
   case 139: return new DRRSched;
   case 140: return new ErrorElement;
   case 141: return new FlowInfo;
   case 142: return new FrontDropQueue;
   case 143: return new FullNoteQueue;
   case 144: return new FullNoteQueue;
   case 145: return new HashSwitch;
   case 146: return new Hub;
   case 147: return new Idle;
   case 148: return new InfiniteSource;
   case 149: return new LinkUnqueue;
   case 150: return new MarkMACHeader;
   ...
   case 158: return new Null1;
   case 159: return new Null2;
   case 160: return new Null3;
   case 161: return new Null4;
   case 162: return new Null5;
   case 163: return new Null6;
   case 164: return new Null7;
   case 165: return new Null8;
   case 166: return new Paint;
   case 167: return new PaintSwitch;
   case 168: return new PaintTee;
   case 169: return new PortInfo;
   case 170: return new Print;
   case 171: return new PrioSched;
   case 172: return new PullSwitch;
   case 173: return new QuickNoteQueue;
   case 174: return new QuitWatcher;
   case 175: return new RandomBitErrors;
   case 176: return new RandomSample;
   case 177: return new RandomSource;
   case 178: return new RandomSwitch;
   case 179: return new RatedSource;
   case 180: return new RatedSplitter;
   case 181: return new RatedUnqueue;
   case 182: return new RRSched;
   case 183: return new RoundRobinSwitch;
   case 184: return new ScheduleInfo;
   case 185: return new Script;
   case 186: return new SetAnnoByte;
   case 187: return new SetCRC32;
   case 188: return new SetPacketType;
   case 189: return new SetTimestamp;
   case 190: return new Shaper;
   case 191: return new SimpleQueue;
   case 192: return new StaticPullSwitch;
   case 193: return new StaticSwitch;
   case 194: return new StoreData;
   case 195: return new StrideSched;
   case 196: return new StrideSwitch;
   case 197: return new Strip;
   case 198: return new StripToNetworkHeader;
   case 199: return new Suppressor;
   case 200: return new Switch;
   case 201: return new Tee;
   case 202: return new PullTee;
   case 203: return new ThreadSafeQueue;
   case 204: return new TimedSink;
   case 205: return new TimedSource;
   case 206: return new TimedUnqueue;
   case 207: return new Truncate;
   case 208: return new Unqueue;
   case 209: return new Unqueue2;
   case 210: return new Unstrip;
   case 211: return new CheckTCPHeader;
   case 212: return new CheckUDPHeader;
   case 213: return new DynamicUDPIPEncap;
   case 214: return new IPRewriter;
   case 215: return new SetTCPChecksum;
   case 216: return new SetUDPChecksum;
   case 217: return new TCPFragmenter;
   case 218: return new TCPIPSend;
   case 219: return new TCPRewriter;
   case 220: return new UDPIPEncap;
   case 221: return new UDPRewriter;
   case 222: return new BigHashMapTest;
   case 223: return new BigintTest;
   case 224: return new BlockThread;
   case 225: return new CheckPacket;
   case 226: return new CLPTest;
   case 227: return new ComparePackets;
   case 228: return new ConfParseTest;
   case 229: return new CryptoTest;
   case 230: return new ErrorTest;
   case 231: return new FunctionTest;
   case 232: return new HandlerTask;
   case 233: return new HashTableTest;
   case 234: return new HeapTest;
   case 235: return new ListTest;
   case 236: return new NeighborhoodTest;
   case 237: return new NotifierDebug;
   case 238: return new NullTask;
   case 239: return new PacketTest;
   case 240: return new QueueYankTest;
   case 241: return new RandomSeed;
   case 242: return new SchedOrderTest;
   case 243: return new SortTest;
   case 244: return new TimerTest;
   case 245: return new TokenBucketTest;
   case 246: return new UpstreamNotifier;
   case 247: return new VectorTest;
   case 248: return new SpinlockAcquire;
   case 249: return new SpinlockInfo;
   case 250: return new SpinlockRelease;
   case 251: return new StaticThreadSched;
   case 252: return new ChangeUID;
   case 253: return new ChatterSocket;
   case 254: return new ControlSocket;
   case 255: return new FromDevice;
   case 256: return new FromDump;
   case 257: return new FromHost;
   case 258: return new FromRawSocket;
   case 259: return new FromSocket;
   case 260: return new KernelFilter;
   case 261: return new KernelTap;
   case 262: return new KernelTun;
   case 263: return new KernelHandlerProxy;
   case 264: return new ProgressBar;
   case 265: return new RawSocket;
   case 266: return new Socket;
   case 267: return new ToDevice;
   case 268: return new ToDump;
   case 269: return new ToHost;
   case 270: return new ToRawSocket;
   case 271: return new ToSocket;
   case 272: return new UMLSwitch;
   default: return 0;
  }
}
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("multicastuser", beetlemonkey, 109);
  (void) click_add_element_type_stable("SimpleIdle", beetlemonkey, 110);
  (void) click_add_element_type_stable("SimplePrioSched", beetlemonkey, 111);
  (void) click_add_element_type_stable("SimplePullSwitch", beetlemonkey, 112);
  (void) click_add_element_type_stable("SimpleRoundRobinSched", beetlemonkey, 113);
  (void) click_add_element_type_stable("AddressInfo", beetlemonkey, 114);
  (void) click_add_element_type_stable("Align", beetlemonkey, 115);
  (void) click_add_element_type_stable("AlignmentInfo", beetlemonkey, 116);
  (void) click_add_element_type_stable("AnnotationInfo", beetlemonkey, 117);
  (void) click_add_element_type_stable("AverageCounter", beetlemonkey, 118);
  (void) click_add_element_type_stable("BandwidthMeter", beetlemonkey, 119);
  (void) click_add_element_type_stable("BandwidthShaper", beetlemonkey, 120);
  (void) click_add_element_type_stable("Block", beetlemonkey, 121);
  (void) click_add_element_type_stable("Burster", beetlemonkey, 122);
  (void) click_add_element_type_stable("BandwidthRatedSplitter", beetlemonkey, 123);
  (void) click_add_element_type_stable("BandwidthRatedUnqueue", beetlemonkey, 124);
  ...
  (void) click_add_element_type_stable("CompareBlock", beetlemonkey, 130);
  (void) click_add_element_type_stable("Counter", beetlemonkey, 131);
  (void) click_add_element_type_stable("DelayShaper", beetlemonkey, 132);
  (void) click_add_element_type_stable("DelayUnqueue", beetlemonkey, 133);
  (void) click_add_element_type_stable("DevirtualizeInfo", beetlemonkey, 134);
  (void) click_add_element_type_stable("Discard", beetlemonkey, 135);
  (void) click_add_element_type_stable("DiscardNoFree", beetlemonkey, 136);
  (void) click_add_element_type_stable("DriverManager", beetlemonkey, 137);
  (void) click_add_element_type_stable("DropBroadcasts", beetlemonkey, 138);
  (void) click_add_element_type_stable("DRRSched", beetlemonkey, 139);
  (void) click_add_element_type_stable("ErrorElement", beetlemonkey, 140);
  (void) click_add_element_type_stable("FlowInfo", beetlemonkey, 141);
  (void) click_add_element_type_stable("FrontDropQueue", beetlemonkey, 142);
  (void) click_add_element_type_stable("Queue", beetlemonkey, 143);
  (void) click_add_element_type_stable("FullNoteQueue", beetlemonkey, 144);
  (void) click_add_element_type_stable("HashSwitch", beetlemonkey, 145);
  (void) click_add_element_type_stable("Hub", beetlemonkey, 146);
  (void) click_add_element_type_stable("Idle", beetlemonkey, 147);
  (void) click_add_element_type_stable("InfiniteSource", beetlemonkey, 148);
  (void) click_add_element_type_stable("LinkUnqueue", beetlemonkey, 149);
  (void) click_add_element_type_stable("MarkMACHeader", beetlemonkey, 150);
  (void) click_add_element_type_stable("Message", beetlemonkey, 151);
  (void) click_add_element_type_stable("Meter", beetlemonkey, 152);
  (void) click_add_element_type_stable("MixedQueue", beetlemonkey, 153);
  (void) click_add_element_type_stable("NotifierQueue", beetlemonkey, 154);
  (void) click_add_element_type_stable("Null", beetlemonkey, 155);
  (void) click_add_element_type_stable("PushNull", beetlemonkey, 156);
  (void) click_add_element_type_stable("PullNull", beetlemonkey, 157);
  (void) click_add_element_type_stable("Null1", beetlemonkey, 158);
  (void) click_add_element_type_stable("Null2", beetlemonkey, 159);
  (void) click_add_element_type_stable("Null3", beetlemonkey, 160);
  (void) click_add_element_type_stable("Null4", beetlemonkey, 161);
  (void) click_add_element_type_stable("Null5", beetlemonkey, 162);
  (void) click_add_element_type_stable("Null6", beetlemonkey, 163);
  (void) click_add_element_type_stable("Null7", beetlemonkey, 164);
  (void) click_add_element_type_stable("Null8", beetlemonkey, 165);
  (void) click_add_element_type_stable("Paint", beetlemonkey, 166);
  (void) click_add_element_type_stable("PaintSwitch", beetlemonkey, 167);
  (void) click_add_element_type_stable("PaintTee", beetlemonkey, 168);
  (void) click_add_element_type_stable("PortInfo", beetlemonkey, 169);
  (void) click_add_element_type_stable("Print", beetlemonkey, 170);
  (void) click_add_element_type_stable("PrioSched", beetlemonkey, 171);
  (void) click_add_element_type_stable("PullSwitch", beetlemonkey, 172);
  (void) click_add_element_type_stable("QuickNoteQueue", beetlemonkey, 173);
  (void) click_add_element_type_stable("QuitWatcher", beetlemonkey, 174);
  (void) click_add_element_type_stable("RandomBitErrors", beetlemonkey, 175);
  (void) click_add_element_type_stable("RandomSample", beetlemonkey, 176);
  (void) click_add_element_type_stable("RandomSource", beetlemonkey, 177);
  (void) click_add_element_type_stable("RandomSwitch", beetlemonkey, 178);
  (void) click_add_element_type_stable("RatedSource", beetlemonkey, 179);
  (void) click_add_element_type_stable("RatedSplitter", beetlemonkey, 180);
  (void) click_add_element_type_stable("RatedUnqueue", beetlemonkey, 181);
  (void) click_add_element_type_stable("RoundRobinSched", beetlemonkey, 182);
  (void) click_add_element_type_stable("RoundRobinSwitch", beetlemonkey, 183);
  (void) click_add_element_type_stable("ScheduleInfo", beetlemonkey, 184);
  (void) click_add_element_type_stable("Script", beetlemonkey, 185);
  Script::static_initialize();
  (void) click_add_element_type_stable("SetAnnoByte", beetlemonkey, 186);
  (void) click_add_element_type_stable("SetCRC32", beetlemonkey, 187);
  (void) click_add_element_type_stable("SetPacketType", beetlemonkey, 188);
  (void) click_add_element_type_stable("SetTimestamp", beetlemonkey, 189);
  (void) click_add_element_type_stable("Shaper", beetlemonkey, 190);
  (void) click_add_element_type_stable("SimpleQueue", beetlemonkey, 191);
  (void) click_add_element_type_stable("StaticPullSwitch", beetlemonkey, 192);
  (void) click_add_element_type_stable("StaticSwitch", beetlemonkey, 193);
  (void) click_add_element_type_stable("StoreData", beetlemonkey, 194);
  (void) click_add_element_type_stable("StrideSched", beetlemonkey, 195);
  (void) click_add_element_type_stable("StrideSwitch", beetlemonkey, 196);
  (void) click_add_element_type_stable("Strip", beetlemonkey, 197);
  (void) click_add_element_type_stable("StripToNetworkHeader", beetlemonkey, 198);
  (void) click_add_element_type_stable("Suppressor", beetlemonkey, 199);
  (void) click_add_element_type_stable("Switch", beetlemonkey, 200);
  (void) click_add_element_type_stable("Tee", beetlemonkey, 201);
  (void) click_add_element_type_stable("PullTee", beetlemonkey, 202);
  (void) click_add_element_type_stable("ThreadSafeQueue", beetlemonkey, 203);
  (void) click_add_element_type_stable("TimedSink", beetlemonkey, 204);
  (void) click_add_element_type_stable("TimedSource", beetlemonkey, 205);
  (void) click_add_element_type_stable("TimedUnqueue", beetlemonkey, 206);
  (void) click_add_element_type_stable("Truncate", beetlemonkey, 207);
  (void) click_add_element_type_stable("Unqueue", beetlemonkey, 208);
  (void) click_add_element_type_stable("Unqueue2", beetlemonkey, 209);
  (void) click_add_element_type_stable("Unstrip", beetlemonkey, 210);
  (void) click_add_element_type_stable("CheckTCPHeader", beetlemonkey, 211);
  (void) click_add_element_type_stable("CheckUDPHeader", beetlemonkey, 212);
  (void) click_add_element_type_stable("DynamicUDPIPEncap", beetlemonkey, 213);
  (void) click_add_element_type_stable("IPRewriter", beetlemonkey, 214);
  (void) click_add_element_type_stable("SetTCPChecksum", beetlemonkey, 215);
  (void) click_add_element_type_stable("SetUDPChecksum", beetlemonkey, 216);
  (void) click_add_element_type_stable("TCPFragmenter", beetlemonkey, 217);
  (void) click_add_element_type_stable("TCPIPSend", beetlemonkey, 218);
  (void) click_add_element_type_stable("TCPRewriter", beetlemonkey, 219);
  (void) click_add_element_type_stable("UDPIPEncap", beetlemonkey, 220);
  (void) click_add_element_type_stable("UDPRewriter", beetlemonkey, 221);
  (void) click_add_element_type_stable("BigHashMapTest", beetlemonkey, 222);
  (void) click_add_element_type_stable("BigintTest", beetlemonkey, 223);
  (void) click_add_element_type_stable("BlockThread", beetlemonkey, 224);
  (void) click_add_element_type_stable("CheckPacket", beetlemonkey, 225);
  (void) click_add_element_type_stable("CLPTest", beetlemonkey, 226);
  (void) click_add_element_type_stable("ComparePackets", beetlemonkey, 227);
  (void) click_add_element_type_stable("ConfParseTest", beetlemonkey, 228);
  (void) click_add_element_type_stable("CryptoTest", beetlemonkey, 229);
  (void) click_add_element_type_stable("ErrorTest", beetlemonkey, 230);
  (void) click_add_element_type_stable("FunctionTest", beetlemonkey, 231);
  (void) click_add_element_type_stable("HandlerTask", beetlemonkey, 232);
  (void) click_add_element_type_stable("HashTableTest", beetlemonkey, 233);
  (void) click_add_element_type_stable("HeapTest", beetlemonkey, 234);
  (void) click_add_element_type_stable("ListTest", beetlemonkey, 235);
  (void) click_add_element_type_stable("NeighborhoodTest", beetlemonkey, 236);
  (void) click_add_element_type_stable("NotifierDebug", beetlemonkey, 237);
  (void) click_add_element_type_stable("NullTask", beetlemonkey, 238);
  (void) click_add_element_type_stable("PacketTest", beetlemonkey, 239);
  (void) click_add_element_type_stable("QueueYankTest", beetlemonkey, 240);
  (void) click_add_element_type_stable("RandomSeed", beetlemonkey, 241);
  (void) click_add_element_type_stable("SchedOrderTest", beetlemonkey, 242);
  (void) click_add_element_type_stable("SortTest", beetlemonkey, 243);
  (void) click_add_element_type_stable("TimerTest", beetlemonkey, 244);
  (void) click_add_element_type_stable("TokenBucketTest", beetlemonkey, 245);
  (void) click_add_element_type_stable("UpstreamNotifier", beetlemonkey, 246);
  (void) click_add_element_type_stable("VectorTest", beetlemonkey, 247);
  (void) click_add_element_type_stable("SpinlockAcquire", beetlemonkey, 248);
  (void) click_add_element_type_stable("SpinlockInfo", beetlemonkey, 249);
  (void) click_add_element_type_stable("SpinlockRelease", beetlemonkey, 250);
  (void) click_add_element_type_stable("StaticThreadSched", beetlemonkey, 251);
  (void) click_add_element_type_stable("ChangeUID", beetlemonkey, 252);
  (void) click_add_element_type_stable("ChatterSocket", beetlemonkey, 253);
  (void) click_add_element_type_stable("ControlSocket", beetlemonkey, 254);
  (void) click_add_element_type_stable("FromDevice", beetlemonkey, 255);
  (void) click_add_element_type_stable("FromDump", beetlemonkey, 256);
  (void) click_add_element_type_stable("FromHost", beetlemonkey, 257);
  (void) click_add_element_type_stable("FromRawSocket", beetlemonkey, 258);
  (void) click_add_element_type_stable("FromSocket", beetlemonkey, 259);
  (void) click_add_element_type_stable("KernelFilter", beetlemonkey, 260);
  (void) click_add_element_type_stable("KernelTap", beetlemonkey, 261);
  (void) click_add_element_type_stable("KernelTun", beetlemonkey, 262);
  (void) click_add_element_type_stable("KernelHandlerProxy", beetlemonkey, 263);
  (void) click_add_element_type_stable("ProgressBar", beetlemonkey, 264);
  (void) click_add_element_type_stable("RawSocket", beetlemonkey, 265);
  (void) click_add_element_type_stable("Socket", beetlemonkey, 266);
  (void) click_add_element_type_stable("ToDevice", beetlemonkey, 267);
  (void) click_add_element_type_stable("ToDump", beetlemonkey, 268);
  (void) click_add_element_type_stable("ToHost", beetlemonkey, 269);
  (void) click_add_element_type_stable("ToRawSocket", beetlemonkey, 270);
  (void) click_add_element_type_stable("ToSocket", beetlemonkey, 271);
  (void) click_add_element_type_stable("UMLSwitch", beetlemonkey, 272);
