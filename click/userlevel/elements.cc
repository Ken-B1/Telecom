/* Generated by "click-buildtool elem2export" on Sam Nov 26 14:08:08 CET 2016 */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 111: return new QueryGenerator;
   case 112: return new QueryResponder;
   case 113: return new IGMPRouterState;
   case 114: return new UserinfoBase;
   case 115: return new SimpleIdle;
   case 116: return new SimplePrioSched;
   case 117: return new SimplePullSwitch;
   case 118: return new SimpleRRSched;
   case 119: return new AddressInfo;
   case 120: return new Align;
   case 121: return new AlignmentInfo;
   case 122: return new AnnotationInfo;
   case 123: return new AverageCounter;
   case 124: return new BandwidthMeter;
   case 125: return new BandwidthShaper;
   case 126: return new Block;
   case 127: return new Burster;
   case 128: return new BandwidthRatedSplitter;
   case 129: return new BandwidthRatedUnqueue;
   case 130: return new CheckCRC32;
   case 131: return new CheckLength;
   case 132: return new CheckPaint;
   case 133: return new Classifier;
   case 134: return new ClickyInfo;
   case 135: return new CompareBlock;
   case 136: return new Counter;
   case 137: return new DelayShaper;
   case 138: return new DelayUnqueue;
   case 139: return new DevirtualizeInfo;
   case 140: return new Discard;
   case 141: return new DiscardNoFree;
   case 142: return new DriverManager;
   case 143: return new DropBroadcasts;
   case 144: return new DRRSched;
   case 145: return new ErrorElement;
   case 146: return new FlowInfo;
   case 147: return new FrontDropQueue;
   case 148: return new FullNoteQueue;
   case 149: return new FullNoteQueue;
   case 150: return new HashSwitch;
   case 151: return new Hub;
   case 152: return new Idle;
   case 153: return new InfiniteSource;
   case 154: return new LinkUnqueue;
   case 155: return new MarkMACHeader;
   case 156: return new MessageElement;
   case 157: return new Meter;
   case 158: return new MixedQueue;
   case 159: return new NotifierQueue;
   case 160: return new NullElement;
   case 161: return new PushNullElement;
   case 162: return new PullNullElement;
   case 163: return new Null1;
   case 164: return new Null2;
   case 165: return new Null3;
   case 166: return new Null4;
   case 167: return new Null5;
   case 168: return new Null6;
   case 169: return new Null7;
   case 170: return new Null8;
   ...
   case 187: return new RRSched;
   case 188: return new RoundRobinSwitch;
   case 189: return new ScheduleInfo;
   case 190: return new Script;
   case 191: return new SetAnnoByte;
   case 192: return new SetCRC32;
   case 193: return new SetPacketType;
   case 194: return new SetTimestamp;
   case 195: return new Shaper;
   case 196: return new SimpleQueue;
   case 197: return new StaticPullSwitch;
   case 198: return new StaticSwitch;
   case 199: return new StoreData;
   case 200: return new StrideSched;
   case 201: return new StrideSwitch;
   case 202: return new Strip;
   case 203: return new StripToNetworkHeader;
   case 204: return new Suppressor;
   case 205: return new Switch;
   case 206: return new Tee;
   case 207: return new PullTee;
   case 208: return new ThreadSafeQueue;
   case 209: return new TimedSink;
   case 210: return new TimedSource;
   case 211: return new TimedUnqueue;
   case 212: return new Truncate;
   case 213: return new Unqueue;
   case 214: return new Unqueue2;
   case 215: return new Unstrip;
   case 216: return new CheckTCPHeader;
   case 217: return new CheckUDPHeader;
   case 218: return new DynamicUDPIPEncap;
   case 219: return new IPRewriter;
   case 220: return new SetTCPChecksum;
   case 221: return new SetUDPChecksum;
   case 222: return new TCPFragmenter;
   case 223: return new TCPIPSend;
   case 224: return new TCPRewriter;
   case 225: return new UDPIPEncap;
   case 226: return new UDPRewriter;
   case 227: return new BigHashMapTest;
   case 228: return new BigintTest;
   case 229: return new BlockThread;
   case 230: return new CheckPacket;
   case 231: return new CLPTest;
   case 232: return new ComparePackets;
   case 233: return new ConfParseTest;
   case 234: return new CryptoTest;
   case 235: return new ErrorTest;
   case 236: return new FunctionTest;
   case 237: return new HandlerTask;
   case 238: return new HashTableTest;
   case 239: return new HeapTest;
   case 240: return new ListTest;
   case 241: return new NeighborhoodTest;
   case 242: return new NotifierDebug;
   case 243: return new NullTask;
   case 244: return new PacketTest;
   case 245: return new QueueYankTest;
   case 246: return new RandomSeed;
   case 247: return new SchedOrderTest;
   case 248: return new SortTest;
   case 249: return new TimerTest;
   case 250: return new TokenBucketTest;
   case 251: return new UpstreamNotifier;
   case 252: return new VectorTest;
   case 253: return new SpinlockAcquire;
   case 254: return new SpinlockInfo;
   case 255: return new SpinlockRelease;
   case 256: return new StaticThreadSched;
   case 257: return new ChangeUID;
   case 258: return new ChatterSocket;
   case 259: return new ControlSocket;
   case 260: return new FromDevice;
   case 261: return new FromDump;
   case 262: return new FromHost;
   case 263: return new FromRawSocket;
   case 264: return new FromSocket;
   case 265: return new KernelFilter;
   case 266: return new KernelTap;
   case 267: return new KernelTun;
   case 268: return new KernelHandlerProxy;
   case 269: return new ProgressBar;
   case 270: return new RawSocket;
   case 271: return new Socket;
   case 272: return new ToDevice;
   case 273: return new ToDump;
   case 274: return new ToHost;
   case 275: return new ToRawSocket;
   case 276: return new ToSocket;
   case 277: return new UMLSwitch;
   default: return 0;
  }
}
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("RecordGenerator", beetlemonkey, 110);
  (void) click_add_element_type_stable("QueryGenerator", beetlemonkey, 111);
  (void) click_add_element_type_stable("QueryResponder", beetlemonkey, 112);
  (void) click_add_element_type_stable("IGMPRouterState", beetlemonkey, 113);
  (void) click_add_element_type_stable("UserinfoBase", beetlemonkey, 114);
  (void) click_add_element_type_stable("SimpleIdle", beetlemonkey, 115);
  (void) click_add_element_type_stable("SimplePrioSched", beetlemonkey, 116);
  (void) click_add_element_type_stable("SimplePullSwitch", beetlemonkey, 117);
  (void) click_add_element_type_stable("SimpleRoundRobinSched", beetlemonkey, 118);
  (void) click_add_element_type_stable("AddressInfo", beetlemonkey, 119);
  (void) click_add_element_type_stable("Align", beetlemonkey, 120);
  (void) click_add_element_type_stable("AlignmentInfo", beetlemonkey, 121);
  (void) click_add_element_type_stable("AnnotationInfo", beetlemonkey, 122);
  (void) click_add_element_type_stable("AverageCounter", beetlemonkey, 123);
  (void) click_add_element_type_stable("BandwidthMeter", beetlemonkey, 124);
  (void) click_add_element_type_stable("BandwidthShaper", beetlemonkey, 125);
  (void) click_add_element_type_stable("Block", beetlemonkey, 126);
  (void) click_add_element_type_stable("Burster", beetlemonkey, 127);
  (void) click_add_element_type_stable("BandwidthRatedSplitter", beetlemonkey, 128);
  (void) click_add_element_type_stable("BandwidthRatedUnqueue", beetlemonkey, 129);
  (void) click_add_element_type_stable("CheckCRC32", beetlemonkey, 130);
  (void) click_add_element_type_stable("CheckLength", beetlemonkey, 131);
  (void) click_add_element_type_stable("CheckPaint", beetlemonkey, 132);
  (void) click_add_element_type_stable("Classifier", beetlemonkey, 133);
  (void) click_add_element_type_stable("ClickyInfo", beetlemonkey, 134);
  (void) click_add_element_type_stable("CompareBlock", beetlemonkey, 135);
  (void) click_add_element_type_stable("Counter", beetlemonkey, 136);
  (void) click_add_element_type_stable("DelayShaper", beetlemonkey, 137);
  (void) click_add_element_type_stable("DelayUnqueue", beetlemonkey, 138);
  (void) click_add_element_type_stable("DevirtualizeInfo", beetlemonkey, 139);
  (void) click_add_element_type_stable("Discard", beetlemonkey, 140);
  (void) click_add_element_type_stable("DiscardNoFree", beetlemonkey, 141);
  (void) click_add_element_type_stable("DriverManager", beetlemonkey, 142);
  (void) click_add_element_type_stable("DropBroadcasts", beetlemonkey, 143);
  (void) click_add_element_type_stable("DRRSched", beetlemonkey, 144);
  (void) click_add_element_type_stable("ErrorElement", beetlemonkey, 145);
  (void) click_add_element_type_stable("FlowInfo", beetlemonkey, 146);
  (void) click_add_element_type_stable("FrontDropQueue", beetlemonkey, 147);
  (void) click_add_element_type_stable("Queue", beetlemonkey, 148);
  (void) click_add_element_type_stable("FullNoteQueue", beetlemonkey, 149);
  (void) click_add_element_type_stable("HashSwitch", beetlemonkey, 150);
  (void) click_add_element_type_stable("Hub", beetlemonkey, 151);
  (void) click_add_element_type_stable("Idle", beetlemonkey, 152);
  (void) click_add_element_type_stable("InfiniteSource", beetlemonkey, 153);
  (void) click_add_element_type_stable("LinkUnqueue", beetlemonkey, 154);
  (void) click_add_element_type_stable("MarkMACHeader", beetlemonkey, 155);
  (void) click_add_element_type_stable("Message", beetlemonkey, 156);
  (void) click_add_element_type_stable("Meter", beetlemonkey, 157);
  (void) click_add_element_type_stable("MixedQueue", beetlemonkey, 158);
  (void) click_add_element_type_stable("NotifierQueue", beetlemonkey, 159);
  (void) click_add_element_type_stable("Null", beetlemonkey, 160);
  (void) click_add_element_type_stable("PushNull", beetlemonkey, 161);
  (void) click_add_element_type_stable("PullNull", beetlemonkey, 162);
  (void) click_add_element_type_stable("Null1", beetlemonkey, 163);
  (void) click_add_element_type_stable("Null2", beetlemonkey, 164);
  (void) click_add_element_type_stable("Null3", beetlemonkey, 165);
  (void) click_add_element_type_stable("Null4", beetlemonkey, 166);
  (void) click_add_element_type_stable("Null5", beetlemonkey, 167);
  (void) click_add_element_type_stable("Null6", beetlemonkey, 168);
  (void) click_add_element_type_stable("Null7", beetlemonkey, 169);
  (void) click_add_element_type_stable("Null8", beetlemonkey, 170);
  ...
  (void) click_add_element_type_stable("RoundRobinSched", beetlemonkey, 187);
  (void) click_add_element_type_stable("RoundRobinSwitch", beetlemonkey, 188);
  (void) click_add_element_type_stable("ScheduleInfo", beetlemonkey, 189);
  (void) click_add_element_type_stable("Script", beetlemonkey, 190);
  Script::static_initialize();
  (void) click_add_element_type_stable("SetAnnoByte", beetlemonkey, 191);
  (void) click_add_element_type_stable("SetCRC32", beetlemonkey, 192);
  (void) click_add_element_type_stable("SetPacketType", beetlemonkey, 193);
  (void) click_add_element_type_stable("SetTimestamp", beetlemonkey, 194);
  (void) click_add_element_type_stable("Shaper", beetlemonkey, 195);
  (void) click_add_element_type_stable("SimpleQueue", beetlemonkey, 196);
  (void) click_add_element_type_stable("StaticPullSwitch", beetlemonkey, 197);
  (void) click_add_element_type_stable("StaticSwitch", beetlemonkey, 198);
  (void) click_add_element_type_stable("StoreData", beetlemonkey, 199);
  (void) click_add_element_type_stable("StrideSched", beetlemonkey, 200);
  (void) click_add_element_type_stable("StrideSwitch", beetlemonkey, 201);
  (void) click_add_element_type_stable("Strip", beetlemonkey, 202);
  (void) click_add_element_type_stable("StripToNetworkHeader", beetlemonkey, 203);
  (void) click_add_element_type_stable("Suppressor", beetlemonkey, 204);
  (void) click_add_element_type_stable("Switch", beetlemonkey, 205);
  (void) click_add_element_type_stable("Tee", beetlemonkey, 206);
  (void) click_add_element_type_stable("PullTee", beetlemonkey, 207);
  (void) click_add_element_type_stable("ThreadSafeQueue", beetlemonkey, 208);
  (void) click_add_element_type_stable("TimedSink", beetlemonkey, 209);
  (void) click_add_element_type_stable("TimedSource", beetlemonkey, 210);
  (void) click_add_element_type_stable("TimedUnqueue", beetlemonkey, 211);
  (void) click_add_element_type_stable("Truncate", beetlemonkey, 212);
  (void) click_add_element_type_stable("Unqueue", beetlemonkey, 213);
  (void) click_add_element_type_stable("Unqueue2", beetlemonkey, 214);
  (void) click_add_element_type_stable("Unstrip", beetlemonkey, 215);
  (void) click_add_element_type_stable("CheckTCPHeader", beetlemonkey, 216);
  (void) click_add_element_type_stable("CheckUDPHeader", beetlemonkey, 217);
  (void) click_add_element_type_stable("DynamicUDPIPEncap", beetlemonkey, 218);
  (void) click_add_element_type_stable("IPRewriter", beetlemonkey, 219);
  (void) click_add_element_type_stable("SetTCPChecksum", beetlemonkey, 220);
  (void) click_add_element_type_stable("SetUDPChecksum", beetlemonkey, 221);
  (void) click_add_element_type_stable("TCPFragmenter", beetlemonkey, 222);
  (void) click_add_element_type_stable("TCPIPSend", beetlemonkey, 223);
  (void) click_add_element_type_stable("TCPRewriter", beetlemonkey, 224);
  (void) click_add_element_type_stable("UDPIPEncap", beetlemonkey, 225);
  (void) click_add_element_type_stable("UDPRewriter", beetlemonkey, 226);
  (void) click_add_element_type_stable("BigHashMapTest", beetlemonkey, 227);
  (void) click_add_element_type_stable("BigintTest", beetlemonkey, 228);
  (void) click_add_element_type_stable("BlockThread", beetlemonkey, 229);
  (void) click_add_element_type_stable("CheckPacket", beetlemonkey, 230);
  (void) click_add_element_type_stable("CLPTest", beetlemonkey, 231);
  (void) click_add_element_type_stable("ComparePackets", beetlemonkey, 232);
  (void) click_add_element_type_stable("ConfParseTest", beetlemonkey, 233);
  (void) click_add_element_type_stable("CryptoTest", beetlemonkey, 234);
  (void) click_add_element_type_stable("ErrorTest", beetlemonkey, 235);
  (void) click_add_element_type_stable("FunctionTest", beetlemonkey, 236);
  (void) click_add_element_type_stable("HandlerTask", beetlemonkey, 237);
  (void) click_add_element_type_stable("HashTableTest", beetlemonkey, 238);
  (void) click_add_element_type_stable("HeapTest", beetlemonkey, 239);
  (void) click_add_element_type_stable("ListTest", beetlemonkey, 240);
  (void) click_add_element_type_stable("NeighborhoodTest", beetlemonkey, 241);
  (void) click_add_element_type_stable("NotifierDebug", beetlemonkey, 242);
  (void) click_add_element_type_stable("NullTask", beetlemonkey, 243);
  (void) click_add_element_type_stable("PacketTest", beetlemonkey, 244);
  (void) click_add_element_type_stable("QueueYankTest", beetlemonkey, 245);
  (void) click_add_element_type_stable("RandomSeed", beetlemonkey, 246);
  (void) click_add_element_type_stable("SchedOrderTest", beetlemonkey, 247);
  (void) click_add_element_type_stable("SortTest", beetlemonkey, 248);
  (void) click_add_element_type_stable("TimerTest", beetlemonkey, 249);
  (void) click_add_element_type_stable("TokenBucketTest", beetlemonkey, 250);
  (void) click_add_element_type_stable("UpstreamNotifier", beetlemonkey, 251);
  (void) click_add_element_type_stable("VectorTest", beetlemonkey, 252);
  (void) click_add_element_type_stable("SpinlockAcquire", beetlemonkey, 253);
  (void) click_add_element_type_stable("SpinlockInfo", beetlemonkey, 254);
  (void) click_add_element_type_stable("SpinlockRelease", beetlemonkey, 255);
  (void) click_add_element_type_stable("StaticThreadSched", beetlemonkey, 256);
  (void) click_add_element_type_stable("ChangeUID", beetlemonkey, 257);
  (void) click_add_element_type_stable("ChatterSocket", beetlemonkey, 258);
  (void) click_add_element_type_stable("ControlSocket", beetlemonkey, 259);
  (void) click_add_element_type_stable("FromDevice", beetlemonkey, 260);
  (void) click_add_element_type_stable("FromDump", beetlemonkey, 261);
  (void) click_add_element_type_stable("FromHost", beetlemonkey, 262);
  (void) click_add_element_type_stable("FromRawSocket", beetlemonkey, 263);
  (void) click_add_element_type_stable("FromSocket", beetlemonkey, 264);
  (void) click_add_element_type_stable("KernelFilter", beetlemonkey, 265);
  (void) click_add_element_type_stable("KernelTap", beetlemonkey, 266);
  (void) click_add_element_type_stable("KernelTun", beetlemonkey, 267);
  (void) click_add_element_type_stable("KernelHandlerProxy", beetlemonkey, 268);
  (void) click_add_element_type_stable("ProgressBar", beetlemonkey, 269);
  (void) click_add_element_type_stable("RawSocket", beetlemonkey, 270);
  (void) click_add_element_type_stable("Socket", beetlemonkey, 271);
  (void) click_add_element_type_stable("ToDevice", beetlemonkey, 272);
  (void) click_add_element_type_stable("ToDump", beetlemonkey, 273);
  (void) click_add_element_type_stable("ToHost", beetlemonkey, 274);
  (void) click_add_element_type_stable("ToRawSocket", beetlemonkey, 275);
  (void) click_add_element_type_stable("ToSocket", beetlemonkey, 276);
  (void) click_add_element_type_stable("UMLSwitch", beetlemonkey, 277);
